...
The webpage introduces **Vector Databases** as a new way to interact with abstract data representations (vectors or **embeddings**) derived from machine learning models. It highlights their use in applications like **semantic search** and **recommendation systems**.
...
These new databases shine in many applications like[semantic search](https://en.wikipedia.org/wiki/Semantic_search)and[recommendation systems](https://en.wikipedia.org/wiki/Recommender_system), and here, we&rsquo;ll
...
image of`qdrant`and connecting to it locally, or by trying out[Qdrant&rsquo;s Cloud](https://cloud.qdrant.io/)free tier option until you are ready to make the full switch.
...
As you go through the tutorials, please let us know if any questions come up in our[Discord channel here](https://qdrant.to/discord). 😎##### Was this page useful?
...
Thank you for your feedback! 🙏We are sorry to hear that. 😔You can[edit](https:/github.com/qdrant/landing_page/tree/master/qdrant-landing/content/documentation/overview/_index.md)this page on GitHub, or[create](https://github.com/qdrant/landing_page/issues/new/choose)a GitHub issue.
On this page:
