...
This page summarizes an experimentation process for optimizing a **multimodal RAG** pipeline that handles documents containing both text and images, utilizing **multimodal LLMs** like **GPT-4V** and **GPT-4o**.
...
### [Building a Multi-tenant GenAI gateway using APIM](https://devblogs.microsoft.com/ise/multitenant-genai-gateway-using-apim/)

Sushant Bhalla

November 8, 2024

### [Three Ways to Simplify CI/CD Pipelines on GitHub Actions](https://devblogs.microsoft.com/ise/three-ways-to-simplify-cicd-pipelines-on-github-actions/)
...
[Sign in](https://devblogs.microsoft.com/ise/wp-login.php?redirect_to=https%3A%2F%2Fdevblogs.microsoft.com%2Fise%2Fmultimodal-rag-with-vision%2F)
