...
The Reducto API's chart data extraction pipeline uses a multi-stage process combining OCR and **vision-language models (VLM)** to extract structured data from chart images.
