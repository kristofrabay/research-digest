...
The provided web page details how to use **Model Context Protocol (MCP) servers** within **VS Code** to extend chat capabilities with external tools and services.
