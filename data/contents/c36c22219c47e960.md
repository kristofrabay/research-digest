...
The provided web page details the **Tools** available in the **OpenAI Agents SDK**. Tools allow agents to take actions such as fetching data, running code, or calling external APIs.
